...
function createHectorObject() {
  ...
  switch (currentHectorObject) {
    ...
    case "frustum":
      ...
      break
    case "cylinder":
      object = new THREE.Mesh( new THREE.CylinderGeometry( 75, 75, 350, 40, 5 ), material );
      break
    case "torus":
    ...
    case "tetrahedron":
      ...
      break
    case "plane":
      object = new THREE.Mesh( new THREE.PlaneGeometry( 300, 300 ), material );
      break
    case "circle":
      object = new THREE.Mesh( new THREE.CircleGeometry( 150, 50 ), material );
      break
    case "lathe":
      const points = [];
      for ( let i = 0; i < 50; i ++ ) {
